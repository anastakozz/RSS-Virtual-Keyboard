    ...
    switch (key) {
      case 'backspace':
        ...
        keyItem.addEventListener('click', () => {
          const a = board.elements.textarea.value;
          board.elements.textarea.value = a.substring(0, board.elements.textarea.value.length - 1);
        });
        break;
      ...
      case '9':
        ...
        keyItem.addEventListener('click', () => {
          board.elements.textarea.value += board.properties.capsLock
            ? key.toUpperCase()
            : key.toLowerCase();
        });
        break;
